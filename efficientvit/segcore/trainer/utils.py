...
def loss_masks_med(src_masks, target_masks, num_masks, oversample_ratio=3.0, mode="mean"):
    loss_mask = sigmoid_ce_loss_jit(src_masks, target_masks, 1, mode)
    loss_dice = dice_loss_jit(src_masks, target_masks, 1, mode)
...
def mask_iou(pred_label, label):
    ...
    # print(f"pre.sum={pred_label.sum()}")
